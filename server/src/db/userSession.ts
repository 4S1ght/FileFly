...
export default class UserSession {
     ...
     * @returns session ID
     */
    private static _getUniqueSID(): EavAsync<string> {
    ...
    private static async _performCleanup() {
        ...
        const sessionLengths: Record<UserSessionEntry["type"], number> = {
            short:    Config.$.session_duration_short    * 1000*60,
            long:     Config.$.session_duration_long     * 1000*60*60*24,
            elevated: Config.$.session_duration_elevated * 1000*60
        }
